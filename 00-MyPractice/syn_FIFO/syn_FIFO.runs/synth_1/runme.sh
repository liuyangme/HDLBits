...
HD_PWD='E:/Project/Doing/ProgrammingExercise/HDLBits/00-MyPractice/syn_FIFO/syn_FIFO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log syn_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source syn_fifo.tcl
