...
HD_PWD='E:/Project/Doing/ProgrammingExercise/HDLBits/00-MyPractice/glitchfree_clockswitch/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log glitchfree_clockswitch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source glitchfree_clockswitch.tcl
