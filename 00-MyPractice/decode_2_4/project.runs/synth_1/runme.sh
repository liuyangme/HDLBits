...
HD_PWD='E:/Project/Doing/ProgrammingExercise/HDLBits/00-MyPractice/decode_2_4/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decode2_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decode2_4.tcl
