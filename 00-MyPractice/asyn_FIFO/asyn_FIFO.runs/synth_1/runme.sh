...
HD_PWD='E:/Project/Doing/ProgrammingExercise/HDLBits/00-MyPractice/asyn_FIFO/asyn_FIFO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_async.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_async.tcl
