...
set_property webtalk.parent_dir E:/Project/Doing/ProgrammingExercise/HDLBits/00-MyPractice/asyn_FIFO/asyn_FIFO.cache/wt [current_project]
set_property parent.project_path E:/Project/Doing/ProgrammingExercise/HDLBits/00-MyPractice/asyn_FIFO/asyn_FIFO.xpr [current_project]
...
synth_design -top fifo_async -part xc7z020clg400-2


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef fifo_async.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file fifo_async_utilization_synth.rpt -pb fifo_async_utilization_synth.pb"
