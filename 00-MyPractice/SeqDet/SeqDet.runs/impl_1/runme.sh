...
HD_PWD='E:/Project/Doing/ProgrammingExercise/HDLBits/00-MyPractice/SeqDet/SeqDet.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_det.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seq_det.tcl -notrace
