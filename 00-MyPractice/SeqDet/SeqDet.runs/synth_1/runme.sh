...
HD_PWD='E:/Project/Doing/ProgrammingExercise/HDLBits/00-MyPractice/SeqDet/SeqDet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_det.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_det.tcl
