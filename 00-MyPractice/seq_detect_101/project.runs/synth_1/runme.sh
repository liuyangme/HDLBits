...
HD_PWD='E:/Project/Doing/ProgrammingExercise/HDLBits/00-MyPractice/seq_detect_101/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_detect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_detect.tcl
