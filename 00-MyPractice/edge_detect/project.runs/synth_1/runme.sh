...
HD_PWD='E:/Project/Doing/ProgrammingExercise/HDLBits/00-MyPractice/edge_detect/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log edge_detect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source edge_detect.tcl
